...
> **Also available for [Java](https://github.com/Aniketc068/ATick-Java)** (Maven Central `io.github.aniketc068:atick`)
> and **[.NET](https://github.com/Aniketc068/ATick-DotNet)** (NuGet `ATick`) — the same library, the same API style.
