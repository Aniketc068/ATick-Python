# Sphinx configuration for the ATick for Python documentation site.
...
ogp_site_name = "ATick for Python — PDF digital-signature library"
...
html_title = "ATick for Python Docs"
...
html_theme_options = {
    "logo": {"image_light": "_static/atick_logo.png", "image_dark": "_static/atick_logo.png", "text": "ATick for Python"},
